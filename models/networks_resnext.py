...
from torchvision.models.resnet import Bottleneck, resnet50, resnet101, resnet152, resnext50_32x4d, resnext101_32x8d
...
class BFE(nn.Module):
    def __init__(self, num_classes, width_ratio=0.5, height_ratio=0.5):
        ...
        self.res_part = nn.Sequential(
            Bottleneck(1024, 1024, stride=1, downsample=nn.Sequential(
        ...
        # 2021/03/28 add by tim
        self.res_part[0].conv2 = nn.Conv2d(1024, 1024, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=32, bias=False)
        self.res_part[0].conv3 = nn.Conv2d(1024, 2048, kernel_size=1, stride=1, bias=False)
        self.res_part[0].bn3 = nn.BatchNorm2d(2048, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.res_part[1].conv2 = nn.Conv2d(1024, 1024, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=32, bias=False)
        self.res_part[1].conv3 = nn.Conv2d(1024, 2048, kernel_size=1, stride=1, bias=False)
        self.res_part[1].bn3 = nn.BatchNorm2d(2048, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
        self.res_part[2].conv2 = nn.Conv2d(1024, 1024, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), groups=32, bias=False)
        self.res_part[2].conv3 = nn.Conv2d(1024, 2048, kernel_size=1, stride=1, bias=False)
        self.res_part[2].bn3 = nn.BatchNorm2d(2048, eps=1e-05, momentum=0.1, affine=True, track_running_stats=True)
    ...
    # add by tim 2021/04/30
    def get_model_name(self):
        return '================ Now load ResNext50 ================'
